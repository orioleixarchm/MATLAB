% Filename: sticky_prices_wages_loop_rules_B.mod
...
load pars2;
set_param_value('phi_p',curr_phi_p); % Price rigidity
set_param_value('phi_w',curr_phi_w); % Wage rigidity
...
% Simulation settings
stoch_simul(periods=10000, order=1, irf=20, nograph);